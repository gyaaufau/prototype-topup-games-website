    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
                        ...
                        >
                            ...
                            <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
                                <div className="text-white max-w-2xl animate-fade-in">
                                    <div className="inline-flex items-center gap-2 bg-pink-500/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-pink-500/30">
                                        <Zap className="w-4 h-4 text-pink-400" />
                                        <span className="text-pink-300 text-sm font-semibold">Limited Offer</span>
                                    </div>
                                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-3 leading-tight">
                                        {slide.title}
                                    </h2>
                                    <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-pink-400 mb-4">
                                        {slide.subtitle}
                                    </h3>
                                    <p className="text-slate-200 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 leading-relaxed">
                                        {slide.description}
                                    </p>
                                    <button className="group bg-pink-500 hover:bg-pink-600 text-white font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-200 shadow-2xl hover:shadow-pink-500/50 hover:scale-105 inline-flex items-center gap-2">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                <div className="flex items-center justify-between mb-6 sm:mb-8">
                    <div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-2 flex items-center gap-3">
                            <Star className="w-6 h-6 sm:w-8 sm:h-8 text-pink-400 fill-pink-400" />
                            Popular Games
                        </h2>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6">
                    {displayedGames.map((game, index) => (
                        ...
                        >
                            <div className="bg-slate-900 rounded-xl sm:rounded-2xl overflow-hidden border border-slate-800 hover:border-pink-500 transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:shadow-pink-500/20 card-hover">
                                {/* Game Image */}
                                <div className="aspect-[3/4] overflow-hidden relative bg-slate-800">
                                    ...
                                    {game.category && (
                                        <div className="absolute top-2 left-2">
                                            <span className="bg-slate-900/80 backdrop-blur-sm text-pink-400 text-xs font-semibold px-2 py-1 rounded">
                                                {game.category}
                                            </span>
                                        </div>
                                    )}
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <div className="absolute bottom-0 left-0 right-0 p-3 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                            <span className="inline-block bg-pink-500 text-white text-xs font-bold px-2 py-1 rounded">
                                                Top Up Now
                                            </span>
                                        </div>
                                    </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                <div className="bg-gradient-to-r from-pink-500 via-purple-600 to-blue-500 rounded-2xl sm:rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <button className="bg-slate-900 hover:bg-slate-800 text-white font-bold px-8 sm:px-10 py-3 sm:py-4 rounded-xl transition-all duration-200 shadow-2xl hover:scale-105 inline-flex items-center gap-2">
