            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="space-y-4">                    <Link to="/" className="inline-flex items-center gap-2 group">
                        ...
                        <span className="text-xl font-black bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent">
                            GyaStore
                        </span>
                    </Link>
                        ...
                        <div className="flex items-center gap-3">                        <a
                            href="#"
                            className="bg-slate-800 hover:bg-pink-500 text-slate-400 hover:text-white p-2.5 rounded-lg transition-all duration-200 hover:scale-110"
                            aria-label="Facebook"
                        >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-2 text-slate-400 text-sm">
                                <Mail className="w-4 h-4 mt-0.5 shrink-0 text-pink-500" />
                                <span>support@gyastore.com</span>
                            </li>
                            <li className="flex items-start gap-2 text-slate-400 text-sm">
                                <Phone className="w-4 h-4 mt-0.5 shrink-0 text-pink-500" />
                                <span>+62 812-3456-7890</span>
                            </li>
                            <li className="flex items-start gap-2 text-slate-400 text-sm">
                                <MapPin className="w-4 h-4 mt-0.5 shrink-0 text-pink-500" />
